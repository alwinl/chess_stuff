/*$T DISPLAY.CPP GC 1.123 09/25/01 14:16:46 */
...
//
// OWLCVT 08/22/97 02:11:13 ObjectWindows - (C) Copyright 1992 by Borland
// International
//
...
void PrintCurLevel( void ) {
    ...
    if( MultiMove )
        ...
        switch( Level )
        {
        case normal:        sprintf( buf, "%1.0f sec / move", AverageTime ); break;
        case fullgametime:  sprintf( buf, "%2.2f min / game", AverageTime ); break;
        case easygame:      strcpy( buf, "Easy" ); break;
        case infinite:      strcpy( buf, "Infinte" ); break;
        case plysearch:     sprintf( buf, "Ply-Depth = %d", MaxLevel ); break;
        case matesearch:    strcpy( buf, "MateSearch" ); break;
        case matching:      strcpy( buf, "Match users time" ); break;
        }
    }
...
void InitDisplay( void ) {
    ...
    for( square = 0; square <= 0x77; square++ ) {
        if( !(square & 0x88) ) {
            if
            (
                (Board[square].piece != Display[square].piece)
...
/*
 =======================================================================================================================
    Draw a box in the square of an attacked piece. Square is black if Defended is TRUE, else it is red.
 =======================================================================================================================
 */
...
/*
 =======================================================================================================================
    find a square with a given point and determine whether it contains a player of the given color
 =======================================================================================================================
 */
