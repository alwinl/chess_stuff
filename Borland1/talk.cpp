/*$T TALK.CPP GC 1.123 09/25/01 14:17:49 */
...
//
// OWLCVT 08/22/97 02:12:32 ObjectWindows - (C) Copyright 1992 by Borland
// International
//
...
extern void RemoveMove( MOVESTRUCT * );
static void ThinkAwhile( void );
void        StartMove( void );
...
PIECETYPE   Pieces[8] = { rook, knight, bishop, queen, king, bishop, knight, rook };
BYTE        MaxLevel;
BOOL        Turned;
BOOL        UseLib;
LIBTYPE     Openings;
...
/*
 ...
 =======================================================================================================================
 */
void InsertPiece( PIECETYPE piece, COLORTYPE c, SQUARETYPE square ) {
...
/*
 =======================================================================================================================
    set libno to the next move in the block. Unplayable moves are skipped if skip is set
 =======================================================================================================================
 */
...
void OutputNode( NODEVAL *nodes ) {
    ...
    sprintf( buf, "%12.1f", ((nodes->nodebase * MAXINT) + nodes->nodeoffset) );
...
void ReturnAnalysis( void ) {
    ...
    if( Logging && !AutoPlay ) {
        ...
        *OutputFile << buf;
        sprintf( buf, "    (%s)%9.2f%3d:%2d", MoveStr(&MainLine[1]), MainEvalu / 256.0, MaxDepth, LegalMoves );
        *OutputFile << buf;
        OutputNode( &Nodes );
...
/*
 =======================================================================================================================
    Perform analysis in the opponents time of reflection. The program assumes that the opponent will perform the Hint
    move, and starts analysing on it for a counter move
 =======================================================================================================================
 */
static void ThinkAwhile( void ) {
...
void FindHintMove( void ) {
    /*
     * If hintline is empty the get the move from the opening library or perform a 1 -
     * ply search
     */
