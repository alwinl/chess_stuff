/*$T info.cpp GC 1.123 09/25/01 14:17:09 */
...
//
// OWLCVT 08/22/97 02:14:47 ObjectWindows - (C) Copyright 1992 by Borland
// International
//
...
/*
 ...
 =======================================================================================================================
 */
void TInfoWindow::IterReset( void ) {
    Color->SetText( "White" );
    Value->Clear();
    Nodes->Clear();
    Seconds->Clear();
...
EV_WM_ERASEBKGND, END_RESPONSE_TABLE;

DEFINE_RESPONSE_TABLE1( TInfoWindow, TFrameWindow )
EV_WM_CTLCOLOR, END_RESPONSE_TABLE;
