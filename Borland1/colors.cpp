/*$T COLORS.CPP GC 1.123 09/25/01 14:16:34 */
...
//
// OWLCVT 08/22/97 02:11:05 ObjectWindows - (C) Copyright 1992 by Borland
// International
//
#define _INFO_H
...
/*
 ...
 =======================================================================================================================
 */
TColorsDialog::~TColorsDialog( void ) {
...
void TColorsDialog::Ok( UINT ) {
    ...
    if
    (
        GetColorValue(IDD_WEDITRED)
    &&  GetColorValue(IDD_WEDITGREEN)
    &&  GetColorValue(IDD_WEDITBLUE)
    &&  GetColorValue(IDD_BEDITRED)
    &&  GetColorValue(IDD_BEDITGREEN)
    &&  GetColorValue(IDD_BEDITBLUE)
    ) {
...
/*
 ...
 =======================================================================================================================
 */
void TColorsDialog::SetupWindow( void ) {
    TDialog::SetupWindow();
...
/*
 ...
 =======================================================================================================================
 */
HBRUSH TColorsDialog::EvCtlColor( HDC, HWND, UINT ) {
...
/*
 ...
 =======================================================================================================================
 */
void TColorsDialog::EvVScroll( UINT, UINT, HWND ) {
    TMessage    msg = __GetTMessage();
...
/*
 ...
 =======================================================================================================================
 */
void TColorsDialog::EvDrawItem( UINT, DRAWITEMSTRUCT __far & ) {
    TMessage            msg = __GetTMessage();
    ...
    hOldBrush = ( HBRUSH ) SelectObject( lpDI->hDC, CreateSolidBrush(RGB(colors[0], colors[1], colors[2])) );
...
/*
 ...
 =======================================================================================================================
 */
LRESULT TColorsDialog::CLKillFocus( WPARAM, LPARAM ) {
    TMessage    msg = __GetTMessage();

    //
    // OWLCVT: Unrecognized DDVT value 1125 for 'TColorsDialog::CLKillFocus', generic
    // signature used
    //
    WORD        Id = msg.WParam;
    HWND        Focus = ::GetFocus();
    ...
    if
    (
        (::GetDlgItem(HWindow, Id) == Focus || ::GetDlgItem(HWindow, IDCANCEL) == Focus)
...
/*
 ...
 =======================================================================================================================
 */
LRESULT TColorsDialog::EvCommand( UINT, HWND, UINT ) {
    TMessage    msg = __GetTMessage();
...
EV_WM_CTLCOLOR, EV_WM_VSCROLL, EV_WM_DRAWITEM,
