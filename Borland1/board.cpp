 ...
 */
inline void MovePiece( SQUARETYPE newSquare, SQUARETYPE oldSquare ) {
    BOARDTYPE   SaveBoard;
 ...
 */
void GenCastSquare( SQUARETYPE newSquare, SQUARETYPE *castsquare, SQUARETYPE *cornersquare ) {
 ...
 *  Take back captures
 */
inline void InsertPTabPiece( PIECETYPE inpiece, COLORTYPE incolor, SQUARETYPE insquare ) {
    Board[insquare].piece = PieceTab[incolor][Board[insquare].index].ipiece = inpiece;
...
inline void ChangeType( PIECETYPE newtype, SQUARETYPE insquare ) {
    Board[insquare].piece = PieceTab[Board[insquare].color][Board[insquare].index].ipiece = newtype;
