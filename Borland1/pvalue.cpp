/*$T PVALUE.CPP GC 1.123 09/25/01 14:17:22 */
...
//
// OWLCVT 08/22/97 02:11:56 ObjectWindows - (C) Copyright 1992 by Borland
// International
//
...
BOOL TPieceValueDialog::GetColorValue( WORD Id ) {
    ...
    switch( Id )
    {
    case IDD_EQUEEN:    CurVal = &Values[pvqueen]; hScroller = ::GetDlgItem( HWindow, IDD_QUEEN ); break;
    case IDD_EROOK:     CurVal = &Values[pvrook]; hScroller = ::GetDlgItem( HWindow, IDD_ROOK ); break;
    case IDD_EBISHOP:   CurVal = &Values[pvbishop]; hScroller = ::GetDlgItem( HWindow, IDD_BISHOP ); break;
    case IDD_EKNIGHT:   CurVal = &Values[pvknight]; hScroller = ::GetDlgItem( HWindow, IDD_KNIGHT ); break;
    case IDD_EPAWN:     CurVal = &Values[pvpawn]; hScroller = ::GetDlgItem( HWindow, IDD_PAWN ); break;
    }
...
/*
 ...
 =======================================================================================================================
 */
void TPieceValueDialog::Ok( UINT ) {
    MSG msg;
    ...
    if
    (
        GetColorValue(IDD_EQUEEN)
    &&  GetColorValue(IDD_EROOK)
    &&  GetColorValue(IDD_EBISHOP)
    &&  GetColorValue(IDD_EKNIGHT)
...
/*
 ...
 =======================================================================================================================
 */
void TPieceValueDialog::SetupWindow( void ) {
    TDialog::SetupWindow();
...
/*
 ...
 =======================================================================================================================
 */
void TPieceValueDialog::IDDDefault( UINT ) {
...
/*
 ...
 =======================================================================================================================
 */
void TPieceValueDialog::EvHScroll( UINT, UINT, HWND ) {
...
/*
 ...
 =======================================================================================================================
 */
LRESULT TPieceValueDialog::PVKillFocus( WPARAM, LPARAM ) {
    TMessage    msg = __GetTMessage();

    //
    // OWLCVT: Unrecognized DDVT value 1124 for 'TPieceValueDialog::PVKillFocus',
    // generic signature used
    //
    WORD        Id = msg.WParam;
    HWND        Focus = ::GetFocus();
    ...
    (
        (
            ::GetDlgItem(HWindow, Id) == Focus || ::GetDlgItem(HWindow, IDCANCEL) == Focus || ::GetDlgItem(HWindow,
                                                                                                           IDD_DEFAULT) == Focus
        )
...
/*
 ...
 =======================================================================================================================
 */
LRESULT TPieceValueDialog::EvCommand( UINT, HWND, UINT ) {
    TMessage    msg = __GetTMessage();
