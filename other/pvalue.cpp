...
TPieceValueDialog::TPieceValueDialog(TWindow * AParent, LPSTR AName)
...
// OWLCVT: Unrecognized DDVT value 1124 for 'TPieceValueDialog::PVKillFocus', generic signature used
   WORD Id = msg.WParam;
   HWND Focus = ::GetFocus();
