/*  Project chess
    ...
    OVERVIEW
    ========
    Source file for implementation of chessAboutDlg (TDialog).      
*/
...
chessAboutDlg::chessAboutDlg (TWindow *parent, TResId resId, TModule *module)
...
void chessAboutDlg::SetupWindow ()
{
