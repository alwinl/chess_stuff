...
#ifndef TESTPIECEVALUES_H
#define TESTPIECEVALUES_H
...
class TestPieceValues : public CppUnit::TestFixture
{
public:
    TestPieceValues() {};
    virtual ~TestPieceValues() {};

	CPPUNIT_TEST_SUITE( TestPieceValues );
