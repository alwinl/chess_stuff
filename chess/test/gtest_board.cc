...
TEST( Chess, test_pawn_first_move )
{
	Board board( "8/8/8/8/8/8/4P3/8 w KQkq - 0 1" );
...
TEST( Chess, test_pawn_capture )
{
	Board board( "8/8/8/8/8/3p1p2/4P3/8 w KQkq - 0 1" );
	vector<Ply> moves = board.generate_legal_plys();
...
TEST( Chess, test_pawn_promotion )
{
	Board board( "8/P7/8/8/8/8/8/8 w KQkq - 0 1" );
	vector<Ply> moves = board.generate_legal_plys();
