...
TEST( Chess, test_square_parsing )
{
...
TEST( Chess, piece_scores_depend_on_color )
{
...
TEST( Chess, square_table_values )
{
...
TEST( Chess, test_queen_asymmetry )
{
	vector<string> ranks = {
		// clang-format off
...
TEST( Chess, standard_board_eval_is_zero )
{
	Board board;
...
TEST( Chess, check_all_first_moves )
{
	Board board;
...
TEST( Chess, queen_should_not_capture_rook )
{
	Board board( "4k3/8/6p1/5r2/8/3Q4/8/4K3 w KQkq - 0 1" );
