...
@OOL MultiMove,      // True if multimove mode
...
MOVESTRUCT HintLine[MAXPLY];            /*  suggested hint line  */
...
void FindHintMove()
{
    /*  If hintline is empty the get the move from the opening library or perform a 1 - ply search  */
