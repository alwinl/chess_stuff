...
TColorsDialog::TColorsDialog(TWindow * AParent, LPSTR AName)
...
// OWLCVT: Unrecognized DDVT value 1125 for 'TColorsDialog::CLKillFocus', generic signature used
	WORD Id = msg.WParam;
	HWND Focus = ::GetFocus();
